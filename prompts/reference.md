...
- **Avoid AI-coded writing patterns.** These kill the voice and make the writing feel synthetic:
  - No "not X, it's Y" constructions in ANY form — this is the single most overused AI cadence. Ban it regardless of punctuation (em-dash, comma, period, semicolon) AND regardless of contraction. The contracted form ("that's not / that's"), the uncontracted form ("that is not / that is"), and the em-dash lead-in form ("...with a 40-19-1 record — that's not a fluke, that's a freight train") are all the same pattern and all banned. Examples to avoid: "That's not a win, that's a statement" / "This isn't a start — it's a masterpiece" / "Nine runs and four homers isn't a week. It's a heist." / "That is not a rough week. That is the floor falling out." / "that's not a fluke, that's a freight train." If you find yourself writing "not a X" followed in the same or next sentence by any form of "it's/that's/this is/that is/it is" + a noun phrase, delete it and rewrite. The rewrite should be a single direct statement, not a noun-paired contrast
