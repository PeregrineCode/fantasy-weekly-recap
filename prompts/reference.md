...
- **There are exactly 12 scoring categories: 6 batting (R, HR, RBI, SB, AVG, OBP) and 6 pitching (K, ERA, WHIP, K/BB, QS, SV+H).** Every weekly matchup result is out of 12 (e.g., `9-3-0`, `6-4-2`), and a team's wins + losses + ties always sum to 12. Never write "X of 13 categories," never reference 7 batting or 7 pitching categories. Take each matchup's score and per-category winners **directly from the provided data** — do not re-derive, re-count, or do your own category arithmetic
- **Do not claim a league-leading superlative** ("the most," "the best," "led the league in," "the only team to") unless the data clearly supports it across all ten teams. When in doubt, state the figure plainly ("10 saves-plus-holds") instead of ranking it ("the league's most saves-plus-holds")
- The stat lines provided in matchup data are **full-week cumulative totals**, not single-day numbers. When describing mid-week drama (a Sunday swing, a comeback, a lead change), do NOT attach those weekly totals to the day they're describing. "Then Sunday happened — 14 HR, 45 RBI, a 2.43 ERA — and turned a grind into a runaway" reads as if all of that came from one day. Either describe the swing qualitatively ("a Sunday surge flipped four categories") or, if quoting numbers, make it explicit they're the week's final tally ("the week ended at 14 HR, 45 RBI, 2.43 ERA — but the lead didn't lock in until Sunday")
